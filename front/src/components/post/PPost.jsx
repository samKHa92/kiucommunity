...
export default function PPost(props) {
  ...
  if (!parsedPost) {
    setParsedPost(true);
    APIService.GetPostData(props.id)
      .then((resp) => {
        console.log(resp);
        setpostimage(resp.image1);
        setuserid(resp.user_id);
        setdateposted(resp.date_posted);
        setpostdesc(resp.description);
  ...
  const [isMine, setIsMine] = useState(userid === token["usernametoken"]);
      ...
      <div className="postWrapper">
        <div className="postTop">
          <div className="postTopLeft">
            ...
            <span className="postDate">{dateposted}</span>
          </div>
        ...
        <div className="postCenter">
          <span className="postText">{postdesc}</span>
